  ...
  return (
    <div className="about-container">
      ...
      <p className="slide-up">
        MicroShop was founded with a vision to revolutionize the way small businesses transition into the digital era.
      ...
      <p className="slide-up">
        We’re a diverse group of passionate developers, designers, and problem solvers.
        Our team works around the clock to ensure that MicroShop remains user-friendly, fast, and reliable.
        Each member brings a unique perspective, and together, we innovate to help businesses thrive.
      </p>
      
      <img src={teamImage} alt="Team" className="team-image zoom-in" />

      <div className="color-animation">
        <p>Our core values: Innovation, Simplicity, and Empowerment.</p>
      </div>
    </div>
  );
};
